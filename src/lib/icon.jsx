...
export const Clear = (props) => (
  ...
  >
    <path
      fill="#EF8354"
      d="M11.762 10.707 9.055 8l2.707-2.707-1.055-1.055L8 6.945 5.293 4.238 4.238 5.293 6.945 8l-2.707 2.707 1.055 1.055L8 9.055l2.707 2.707zm-9.07-7.98Q4.906.512 8 .512t5.273 2.215Q15.488 4.906 15.488 8t-2.215 5.309q-2.179 2.18-5.273 2.18t-5.309-2.18Q.511 11.094.511 8q0-3.093 2.18-5.273"
    />
  </svg>
);
